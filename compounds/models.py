...
__all__ = [
    ...
    'EnglishIdentity', 'ChineseIdentity', 'CHEMBLTarget',
    'CHEMBLCompound'
]
...
class CHEMBLCompound(models.Model):
    chembl_id = models.CharField(max_length=64)
    name = models.CharField(max_length=1024, blank=True, null=True)
...
class Compound(models.Model):
    ...
    related_ChEMBL_compounds = models.ManyToManyField(CHEMBLCompound, blank=True)
